...
const extractSvgs = (nextState) => {
  ...
  myWindow.style = "width: 100%; height: 100%; background-color: black; color: white;";
  ...
  container.style = "display: flex; flex-direction: row; gap: 16px; max-width: 100%; flex-wrap: wrap; justify-content: center; align-items: center;";

  svgs.forEach((svg, index) => {
    const svgCard = myWindow.document.createElement("div");
    
    svgCard.id = "svg-card-" + index;
    svgCard.style = "max-width: 300px;  min-height: 100px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);  border: 1px solid #E1F2FE; border-radius: 8px; background-color: white; display: flex; flex-direction: column; padding: 16px; align-items: center; justify-content: space-around;";
    ...
    downloadButton.style = "width: 100%; height: 30px; margin-top: 8px 16px; border: 0px; border-radius: 8px; background-color: #E1F2FE; color: black; cursor: pointer;";
